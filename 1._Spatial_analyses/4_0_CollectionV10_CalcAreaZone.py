  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "1L9rO_63wn5_",
        "outputId": "a29e9fe3-c66d-4ba1-84da-fdaaeb34d386"
      },
      "outputs": [
        {
          "output_type": "stream",
          ...
          "text": [
            ...
            "\n",
            "    https://code.earthengine.google.com/client-auth?scopes=https%3A//www.googleapis.com/auth/earthengine%20https%3A//www.googleapis.com/auth/devstorage.full_control&request_id=IljfF8ceLiELqzy-5nD-TulEXoo_Cq_-e9DsLMQwXnc&tc=y32t2Y319CpUyZX6h5IigMN_D_7rTzbQ1Mg2PFaqd10&cc=wtkwXSDUbhCBGAnkcez7GVZF12ve0BTFLH4qq-Qgkac\n",
            "\n",
            "The authorization workflow will generate a code, which you should paste in the box below.\n",
            "Enter verification code: 4/1AdQt8qhZ9eCWeQkoSexO6Hh9sfst3NS9Jrv5ZKXgUDG2Xsosg8rePjh5Pmg\n",
            "\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "JNt1WTQ1xWDQ",
        "outputId": "1cb1aa93-acb1-435f-fb79-13fbdc3b8e48"
      },
      "outputs": [
        {
          "output_type": "stream",
      ...
      "source": [
        ...
        "        'projects/mapbiomas-workspace/SEEG/2022/c10_1/3_1_SEEG_Transitions_stacked')\n",
        "  \n",
        "    # Here is the multi-band raster of protected areas (PA), where each band is the cumulative of PA areas and units in each year\n",
        "    apMask = ee.Image(\n",
        "        'projects/ee-seeg-brazil/assets/collection_10/v1/areas-protegidas-por-ano-2021/ap' + years[0]).unmask()\n",
        "        # Path 'projects/mapbiomas-workspace/AUXILIAR/areas-protegidas-por-ano-2019'\n",
        "\n",
        ...
        "## 3.3 Set your drive Google Drive  \n",
        "\n",
        "    name = \"SEEG_BR_c10_v1_\"+ \\\n",
        "        years[0]+'-'+ years [1]\n",
        "\n",
        "    task = ee.batch.Export.table.toDrive(\n",
        "        collection=areas,\n",
        "        description=name,\n",
        "        folder='SEEG_c10_v1_1', #Export to your Google Drive or other's path \n",
        "        fileNamePrefix=name,\n",
        "        fileFormat=\"GeoJSON\")           \n",
        "\n",
        "    task.start()\n",
