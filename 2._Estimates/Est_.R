...
write.csv(tran_mun, "Results/tran_mun_intermediario.csv", row.names = F, fileEncoding = "UTF-8")
...
### Rectify the last year with data from PRODES and SEEG (Linear Mod --------
# Rectify the last year with data from PRODES and SEEG (Linear Models)
...
# Correction of the last year of the series based on the deforestation rates
#          provided by official sources (PRODES Amazonia and PRODES Cerrado)
