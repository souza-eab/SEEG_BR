...
setwd('C:/Users/barbara.zimbres/Dropbox/Work/SEEG/Auxiliares c�lculo') #!!!
...
emiss_aggr <- emiss_aggr [, c("SECTOR","LEVEL_2","LEVEL_3","LEVEL_4","LEVEL_5","LEVEL_6","TYPE","GAS","CODIBGE",
...
for(i in gases){
  tabelao_full_final_estados[tabelao_full_final_estados$GAS==i&(tabelao_full_final_estados$LEVEL_3=="Amaz�nia"&
    ...
    tabelao_full_final_estados[tabelao_full_final_estados$Gas==i&(tabelao_full_final_estados$LEVEL_3=="Amaz�nia"&
                                                                    ((tabelao_full_final_estados$LEVEL_2=="Land use change"&
                                                                        tabelao_full_final_estados$LEVEL_5=="Deforestation")|
                                                                       tabelao_full_final_estados$LEVEL_2=="Vegetation residuals")),63]/
    sum(tabelao_full_final_estados[tabelao_full_final_estados$Gas==i&(tabelao_full_final_estados$LEVEL_3=="Amaz�nia"&
                                                                        ((tabelao_full_final_estados$LEVEL_2=="Land use change"&
                                                                            tabelao_full_final_estados$LEVEL_5=="Deforestation")|
...
for(i in gases){
  ...
  tabelao_full_final_estados[tabelao_full_final_estados$Gas==i&(tabelao_full_final_estados$LEVEL_3=="Mata Atl�ntica"&
                                                                  ((tabelao_full_final_estados$LEVEL_2=="Land use change"&
                                                                      tabelao_full_final_estados$LEVEL_5=="Deforestation")|
                                                                     tabelao_full_final_estados$LEVEL_2=="Vegetation residuals")),63]<-
    tabelao_full_final_estados[tabelao_full_final_estados$Gas==i&(tabelao_full_final_estados$LEVEL_3=="Mata Atl�ntica"&
...
for(i in gases){
  ...
  tabelao_full_final_mun_corr[tabelao_full_final_mun_corr$GAS==i&(tabelao_full_final_mun_corr$LEVEL_3=="Mata Atl�ntica"&
                                                                    ((tabelao_full_final_mun_corr$LEVEL_2=="Land use change"&
                                                                        tabelao_full_final_mun_corr$LEVEL_5=="Deforestation")|
                                                                       tabelao_full_final_mun_corr$LEVEL_2=="Vegetation residuals")),64]<-
    tabelao_full_final_mun_corr[tabelao_full_final_mun_corr$GAS==i&(tabelao_full_final_mun_corr$LEVEL_3=="Mata Atl�ntica"&
