...
// Please ignore the Task to export this last non-existing year pair (eg. 2021_2022)
  ...
  "assetId": 'projects/mapbiomas-workspace/SEEG/2022/Transition_maps/SEEG_Transition_mb_' + (parseInt(year))+'_'+(parseInt(year)+1), // Enter the address and name 'project/seeg/col9/v1'of the Asset to be exported
  "scale": 30,
  "pyramidingPolicy": {
      '.default': 'mode'
  },
